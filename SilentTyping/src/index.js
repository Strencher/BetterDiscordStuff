...
import SilentTypingButton from "./components/typingbutton";
import Settings from "./settings";
import Utilities from "./utilities";
import styles from "styles";

export default class SilentTyping extends BasePlugin {
    onStart() {
        styles.inject();
    ...
    patchTextAreaButtons() {
        ...
        Patcher.after(ChannelTextAreaContainer, "render", (_, [{channel, textValue}], returnValue) => {
            ...
            tree.children.unshift(<SilentTypingButton channel={channel} textValue={textValue} />);
        });
    }
