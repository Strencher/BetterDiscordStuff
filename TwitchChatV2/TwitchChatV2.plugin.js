    ...
    const config = {
        ...
        changelog: [
            {
                ...
                type: "added",
                items: [
                    "**Added an External Window for the chat. Activate it in the settings**",
                    "**Added DarkMode**"
                ]
            }
        ],
        defaultConfig: [
            ...
            },
            {
                ...
                note: "Open the chat in an External window.",
                value: false
            },
            {
                type: "switch",
                id: "dark",
                name: "Dark Chat",
                note: "Enables DarkMode on both Chats.",
                value: true
            }
        ]
    };
                                        ...
                                        return React.createElement(Modal, {
                                            ...
                                            children: [
                                                ...
                                                React.createElement(Textbox, {
                                                    ...
                                                    placeholder: "Type the ChannelName, confirm with Enter or Click Open",
                                                    autoFocus: true
                                                }),
