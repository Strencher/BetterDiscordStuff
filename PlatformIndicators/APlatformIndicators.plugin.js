...
const { Messages } = Webpack.getModule((m) => m?.Messages?.STATUS_DND);
const buildClassName = Webpack.getModule((_, __, i) => Webpack.modules[i].toString().includes(`define("classnames"`));

/*@end */

/* @module utils.js */
const findInReactTree = (tree, filter) => Utils.findInTree(tree, filter, { walkable: ["props", "children", "type"] });
...
function Desktop(props) {
    return /* @__PURE__ */ React.createElement("svg", { class: "PI-icon_desktop", width: "24", height: "24", viewBox: "0 -2.5 28 28", ...props }, /* @__PURE__ */ React.createElement("path", { fill: "currentColor", d: "M4 2.5C2.897 2.5 2 3.397 2 4.5V15.5C2 16.604 2.897 17.5 4 17.5H11V19.5H7V21.5H17V19.5H13V17.5H20C21.103 17.5 22 16.604 22 15.5V4.5C22 3.397 21.103 2.5 20 2.5H4ZM20 4.5V13.5H4V4.5H20Z" }));
}
...
/* @module web.jsx */
function Web(props) {
    return /* @__PURE__ */ React.createElement("svg", { class: "PI-icon_web", width: "24", height: "24", viewBox: "0 -2.5 28 28", ...props }, /* @__PURE__ */ React.createElement("path", { fill: "currentColor", d: "M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM11 19.93C7.05 19.44 4 16.08 4 12C4 11.38 4.08 10.79 4.21 10.21L9 15V16C9 17.1 9.9 18 11 18V19.93ZM17.9 17.39C17.64 16.58 16.9 16 16 16H15V13C15 12.45 14.55 12 14 12H8V10H10C10.55 10 11 9.55 11 9V7H13C14.1 7 15 6.1 15 5V4.59C17.93 5.78 20 8.65 20 12C20 14.08 19.2 15.97 17.9 17.39Z" }));
}
...
function StatusIndicators({ type, userId, size = 18, separator = false }) {
    const state = usePlatformStores(userId, type);
    if (!Object.keys(state.clients).length || !state.shouldShow)
        return null;
    return /* @__PURE__ */ React.createElement(React.Fragment, null, separator && /* @__PURE__ */ React.createElement("span", { className: Styles$1.badge_separator }), /* @__PURE__ */ React.createElement("div", { className: buildClassName(Styles$1.indicatorContainer, Styles$1["type_" + type]), "data-id": userId }, Object.entries(state.clients).filter(([key]) => (state.iconStates[key] ?? true) && key in Icons).map(([key, status]) => {
        const Icon = Icons[key];
        return /* @__PURE__ */ React.createElement(ModulesLibrary.Tooltip, { text: getStatusText(key, status) }, (props) => /* @__PURE__ */ React.createElement(
            Icon, {
...
function CheckboxEnabled(props) {
    return /* @__PURE__ */ React.createElement("svg", { width: "24", height: "24", viewBox: "0 0 24 24", ...props }, /* @__PURE__ */ React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", fill: props.color ?? "currentColor", d: "M5.37499 3H18.625C19.9197 3 21.0056 4.08803 21 5.375V18.625C21 19.936 19.9359 21 18.625 21H5.37499C4.06518 21 3 19.936 3 18.625V5.375C3 4.06519 4.06518 3 5.37499 3Z" }), /* @__PURE__ */ React.createElement("path", { fill: "#fff", d: "M9.58473 14.8636L6.04944 11.4051L4.50003 12.9978L9.58473 18L19.5 8.26174L17.9656 6.64795L9.58473 14.8636Z" }));
}

function CheckboxDisabled(props) {
    return /* @__PURE__ */ React.createElement("svg", { width: "24", height: "24", viewBox: "0 0 24 24", ...props }, /* @__PURE__ */ React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", fill: "currentColor", d: "M18.625 3H5.375C4.06519 3 3 4.06519 3 5.375V18.625C3 19.936 4.06519 21 5.375 21H18.625C19.936 21 21 19.936 21 18.625V5.375C21.0057 4.08803 19.9197 3 18.625 3ZM19 19V5H4.99999V19H19Z" }));
}

function Checkbox({ checked, ...props }) {
    return checked ? /* @__PURE__ */ React.createElement(CheckboxEnabled, { ...props }) : /* @__PURE__ */ React.createElement(CheckboxDisabled, { ...props });
}
...
function SmartDisable(props) {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: Styles.PIsettingsSmartDisable }, /* @__PURE__ */ React.createElement("h1", { className: Styles.PIsettingsTitle }, props.name), /* @__PURE__ */ React.createElement("div", { className: Styles.body }, props.items.map((item) => /* @__PURE__ */ React.createElement("div", { key: item.id, className: Styles.item, onClick: () => handleClick(item.id) }, ["online", "dnd", "idle", "offline"].map(
        (status) => React.createElement(Icons[item.icon], {
            style: { color: Colors.ColorDetails[ModulesLibrary.getStatusColor(status)]?.hex },
            width: iconSize,
            height: iconSize
        })
    ), /* @__PURE__ */ React.createElement(Checkbox, { width: iconSize, height: iconSize, checked: !!states[item.id], color: "var(--brand-500)" })))));
}
...
function renderItems(items) {
    return items.map((item) => {
        switch (item.type) {
            case "switch":
                return /* @__PURE__ */ React.createElement(SwitchItem, { ...item });
            case "smart-disable":
                return /* @__PURE__ */ React.createElement(SmartDisable, { ...item });
            default:
                return null;
        }
    });
...
function SettingsPanel() {
    return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h1", { className: Styles.PIsettingsTitle }, "General Settings"), renderItems(SettingsItems));
}
